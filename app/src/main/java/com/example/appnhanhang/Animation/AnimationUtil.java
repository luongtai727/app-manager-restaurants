package com.example.appnhanhang.Animation;
...
public class AnimationUtil {
    ...
    public static void translateAnimation(final ImageView viewAnimation, final View startView, View endView, final  Animation.AnimationListener animationListener)
    {
        ...
        Bitmap cache = startView.getDrawingCache(true);
        ...
        translateScaleAnimation.setDuration(animationDurution);
        ...
        if (isAnimationStart)
        {
            viewAnimation.clearColorFilter();
